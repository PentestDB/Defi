/**
 *Pentest DB And Developer Defi
 //https://pentest-db.com
 // facebook-Group : https://www.facebook.com/groups/blackhack474
 // facebook fanpage : https://www.facebook.com/PTDBC474
 // twitter : https://twitter.com/blackhack474
 // telegram : https://t.me/PenTestDbCryptoCurrency
*/
...
contract SyrupBar is BEP20('Pentest DB', 'PTDBT') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterChef).
    function mint(address _to, uint256 _amount) public onlyOwner {
        _mint(_to, _amount);
        _moveDelegates(address(0), _delegates[_to], _amount);
